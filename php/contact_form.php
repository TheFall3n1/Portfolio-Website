...
if($_POST)
{
	...
	//Recipient email
	$to_email = "chaitanya.v.0312@gmail.com";
	...
	//email subject
	$message_subject = "Your Portfolio was viewed and you've gotten mail from - " . $sender_name . ".";
	...
	{
		$output = json_encode(array('type'=>'message', 'text' => 'Thanks for reaching out to me, ' . $sender_name . '. <br> I will be responding to you as soon as I can.<br>THANK YOU!'));
		die($output);
	}
}
?>
